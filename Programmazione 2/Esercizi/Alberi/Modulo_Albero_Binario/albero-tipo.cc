...
/** Funzione che compara due chiavi e ritorna valori differenti in base all'esito. */

int compareKey(tipo_key k, tipo_key k1) {
...
/** Fuznione che copia la chiave passata come secondo parametro nella prima.*/

void copiaChiave(tipo_key& k,tipo_key k1) {  /** < @param Chiave1Rif @param Chiave2. */
    
    k = k1;

}

/** Funzione che stampa la chiave passata come parametro. */

void printChiave(tipo_key k) {
